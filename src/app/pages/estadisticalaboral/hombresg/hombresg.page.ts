...
@Component({
  selector: 'app-hombresg',
  templateUrl: './hombresg.page.html',
  styleUrls: ['./hombresg.page.scss'],
})
export class HombresgPage implements OnInit {
  ...
  ngOnInit() {
     this.firestore.collection('/Estadistica-Hombres/', ref => ref
