...
@Component({
  selector: 'app-peaocupadag',
  templateUrl: './peaocupadag.page.html',
  styleUrls: ['./peaocupadag.page.scss'],
})
export class PEAOcupadagPage implements OnInit {
  ...
  ngOnInit() {
    this.firestore.collection('/Estadistica-PEA Ocupada/', ref => ref
