...
@Component({
  selector: 'app-peadesocupadag',
  templateUrl: './peadesocupadag.page.html',
  styleUrls: ['./peadesocupadag.page.scss'],
})
export class PEADesocupadagPage implements OnInit {
  ...
  ngOnInit() {
    this.firestore.collection('/Estadistica-PEA Desocupada/', ref => ref
