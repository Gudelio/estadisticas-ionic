...
@Component({
  selector: 'app-tasa-informalidad-laboralg',
  templateUrl: './tasa-informalidad-laboralg.page.html',
  styleUrls: ['./tasa-informalidad-laboralg.page.scss'],
})
export class TasaInformalidadLaboralgPage implements OnInit {
  ...
  ngOnInit() {
    this.firestore.collection('/Estadistica-Tasa Informalidad Laboral/', ref => ref
  ...
  public barChartOptions: ChartConfiguration['options'] = {
    ...
    plugins: {
      title: {
        display: true,
        text: 'Tasa de Informalidad Laboral %'
    },
      legend: {
        display: true,
        position: 'bottom',
