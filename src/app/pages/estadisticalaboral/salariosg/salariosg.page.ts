...
@Component({
  selector: 'app-salariosg',
  templateUrl: './salariosg.page.html',
  styleUrls: ['./salariosg.page.scss'],
})
export class SalariosgPage implements OnInit {
  ...
  ngOnInit() {
    this.firestore.collection('/Estadistica-Salarios/', ref => ref
