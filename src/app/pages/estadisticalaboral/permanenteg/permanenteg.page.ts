...
@Component({
  selector: 'app-permanenteg',
  templateUrl: './permanenteg.page.html',
  styleUrls: ['./permanenteg.page.scss'],
})
export class PermanentegPage implements OnInit {
  ...
  ngOnInit() {
    this.firestore.collection('/Estadistica-Permanente/', ref => ref
