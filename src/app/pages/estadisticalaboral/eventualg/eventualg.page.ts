...
@Component({
  selector: 'app-eventualg',
  templateUrl: './eventualg.page.html',
  styleUrls: ['./eventualg.page.scss'],
})
export class EventualgPage implements OnInit {
  ...
  ngOnInit() {
    this.firestore.collection('/Estadistica - Eventual/', ref => ref
